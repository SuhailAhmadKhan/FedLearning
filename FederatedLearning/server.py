...
def get_evaluate_fn(model):
    ...
    def evaluate(
        ...
        if (server_round == federatedLearningcounts):
            ...
            model.save('saved_models/efficientnetb0')      # save model in SavedModel format
...
def test_updated_model(model):
    ...
    test_image_head_path = "datasets/dataset_test/dog_560.jpg"
    ...
    test_image_hardhat_path = "datasets/dataset_test/cat_604.jpg"
